    ...
    content: (
      <ul className="list-disc pl-5 space-y-3 text-gray-700 text-lg">
        <li className="border-l-4 border-gray-300 pl-2 hover:border-green-400 transition duration-300">
          My certifications and badges are visible at{" "}
          <a
...
const Aboutme = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    const y = e.clientY;
    setTransformStyle({
      transform: `translate(${(x - window.innerWidth / 2) * 0.02}px, ${
        (y - window.innerHeight / 2) * 0.02
      }px)`,
  ...
  return (
    <section
      className="text-black flex justify-center items-center py-16  bg-gray-50"
      id="about"
    ...
    >
      ...
      <div
        ref={ref}
        className="max-w-3xl text-center p-10 mx-6 rounded-lg neuromorphic"
      ...
      >
        ...
        >
          Hi, I&apos;m <strong>Deepanshi Gautam</strong>, a seasoned Web
          Developer dedicated to creating outstanding web experiences. My work
          revolves around transforming design concepts into interactive and
          user-friendly websites. With a solid grasp of web technologies, I take
          great pride in consistently exceeding expectations through the
          delivery of clean and efficient code.I&apos;m passionate about
          learning and continually expanding my skill set. I&apos;m a
          collaborative team player, excited to work with others to create
          amazing applications. I look forward to the opportunity to collaborate
          on web projects!
        </motion.p>
