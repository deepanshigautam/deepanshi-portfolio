// components/main/ProjectCard.jsx
...
export default function ProjectCard({ project, index }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-200 rounded-lg shadow-md overflow-hidden neuromorphic transition-transform duration-300 hover:shadow-lg"
      whileHover={{
        scale: 1.05,
